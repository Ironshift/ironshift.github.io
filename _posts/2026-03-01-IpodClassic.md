...
L'idée est simple : se réapproprier sa musique et se passer de smartphone pour l'écoute quotidienne. Ce projet vise à transformer un appareil "hors service" en un lecteur moderne et fiable.

## État d'origine

Le cobaye est un iPod Classic de 5ème génération "Video", acheté hors-service. Le diagnostic a révélé deux pannes classiques dues à l'âge :
...
_Interne de l'IPOD avant modification_
...
En remplaçant le disque dur par une carte micro-SD moderne, on gagne en vitesse d'accès, en poids et en silence.
...
Une fois les composants internes changés, un travail de polissage a été nécessaire pour redonner son éclat à la façade en polycarbonate.
...
Le résultat est un appareil parfaitement fonctionnel, capable de lire des fichiers FLAC grâce à un nouvel OS.

![Desktop View](/assets/ipod_classic/IpodClassic03.webp)
_L'iPod Classic 5G, rénové_
